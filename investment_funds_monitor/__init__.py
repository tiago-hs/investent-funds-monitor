from investment_funds_monitor.bc_cdi_daily import BCCollector
...
def main():
    ...
    cvm_daily_datasets = CVMCollector(cvm_save_path, cvm_daily_data_url, query_cvm_data)
    cvm_hist_datasets = CVMCollector(cvm_save_path, cvm_hist_data_url, query_cvm_data)
    bacen_cdi_dataset = BCCollector(bacen_cdi_url, bacen_save_path)
